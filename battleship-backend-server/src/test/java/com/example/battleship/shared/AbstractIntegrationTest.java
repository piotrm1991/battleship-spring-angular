package com.example.battleship.shared;

import com.example.battleship.BattleshipServerApplication;
 ...
 */
@SpringBootTest(classes = BattleshipServerApplication.class)
@ActiveProfiles("it")
